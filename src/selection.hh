...
struct BasicSelection {
	...
	friend bool operator==(const BasicSelection&,
	                       const BasicSelection&) = default;
...
void update_selections(Vector<Selection>& selections, size_t& main,
                       const Buffer& buffer, size_t timestamp,
                       bool merge = true);
...
struct SelectionList {
	...
	bool operator==(const SelectionList& other) const {
		return m_buffer == other.m_buffer and
