...
struct Completions {
	enum class Flags { None = 0, Quoted = 0b1, Menu = 0b10, NoEmpty = 0b100 };
...
inline Completions complete_nothing(const Context&, StringView,
...
Completions shell_complete(const Context& context, StringView,
                           ByteCount cursor_pos);
