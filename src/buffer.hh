...
enum class ByteOrderMark { None, Utf8 };
...
public:
	...
	BufferIterator(const StringDataPtr* lines, LineCount line_count,
...
public:
	...
	Buffer(String name, Flags flags, BufferLines lines,
	       ...
	       EolFormat eolformat = EolFormat::Lf, FinalEol = FinalEol::Present,
	...
	const String& name() const {
		return m_flags & Flags::File ? m_filename : m_display_name;
	}
	...
	void reload(BufferLines lines, ByteOrderMark bom, EolFormat eolformat,
	            FinalEol finaleol, FsStatus status);
