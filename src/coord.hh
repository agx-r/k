...
struct LineAndColumn {
	...
	constexpr friend auto operator<=>(const LineAndColumn& lhs,
	                                  const LineAndColumn& rhs) = default;
	constexpr friend bool operator==(const LineAndColumn& lhs,
	                                 const LineAndColumn& rhs) = default;
...
struct BufferCoord : LineAndColumn<BufferCoord, LineCount, ByteCount> {
	...
	constexpr friend auto operator<=>(const BufferCoord& lhs,
	                                  const BufferCoord& rhs) = default;
	constexpr friend bool operator==(const BufferCoord& lhs,
	                                 const BufferCoord& rhs) = default;
};
...
struct DisplayCoord : LineAndColumn<DisplayCoord, LineCount, ColumnCount> {
	...
	constexpr friend auto operator<=>(const DisplayCoord& lhs,
	                                  const DisplayCoord& rhs) = default;
	constexpr friend bool operator==(const DisplayCoord& lhs,
	                                 const DisplayCoord& rhs) = default;
...
struct BufferCoordAndTarget : BufferCoord {
	[[gnu::always_inline]]
	constexpr BufferCoordAndTarget(LineCount line = 0, ByteCount column = 0,
	                               ColumnCount target = -1,
	                               ColumnCount display_target = -1)
