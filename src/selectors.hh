...
select_nested_words(const Context& context, int count, ObjectFlags flags);
Vector<Selection, MemoryDomain::Selections>
select_nested_numbers(const Context& context, int count, ObjectFlags flags);
Vector<Selection, MemoryDomain::Selections>
select_nested_sentences(const Context& context, int count, ObjectFlags flags);
Vector<Selection, MemoryDomain::Selections>
select_nested_paragraphs(const Context& context, int count, ObjectFlags flags);
Vector<Selection, MemoryDomain::Selections>
select_nested_whitespaces(const Context& context, int count, ObjectFlags flags);
Vector<Selection, MemoryDomain::Selections>
select_nested_indents(const Context& context, int count, ObjectFlags flags);
Vector<Selection, MemoryDomain::Selections>
select_nested_arguments(const Context& context, int count, ObjectFlags flags);
Vector<Selection, MemoryDomain::Selections>
regex_select_nested(const Context& context, const Regex& opening,
                    const Regex& closing, int level, ObjectFlags flags);
Vector<Selection, MemoryDomain::Selections>
regex_select_nested(const Context& context, const Regex& delimiter,
                    ObjectFlags flags);
